  ...
  <html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var qtd;
            function getQtd() {
                qtd = document.getElementById('teste').value;
                alert(qtd);
            }
    ...
    <body>
        ...
        Quantidade: <input type="number" id="teste" name="teste">
        <a href="?adicionar=yes"><button onclick="getQtd()">Adicionar</button></a>

        <?php
        if(isset($_REQUEST["adicionar"])) {
            $teste = "<script>document.write(document.getElementById('teste').value;)</script>";
            echo $teste;
        }
        ?>
    </body>
